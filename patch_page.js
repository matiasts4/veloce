...
if (content.includes(oldBlock)) {
    ...
    console.log("Successfully patched app/page.tsx");
} else {
    console.error("Could not find the exact old block in app/page.tsx");
}
